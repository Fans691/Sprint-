...
SPRINT_JAR="$LIB_DIR/sprint0.jar"
...
javac -cp $SPRINT_JAR -d $BUILD_DIR/WEB-INF/classes @sources.txt
rm sources.txt

#Copier uniquement web.xml
cp -r $WEB_DIR/web.xml $BUILD_DIR/WEB-INF/
